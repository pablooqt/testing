...
const Services = () => {
  return (
    <div className="bg-white py-16 px-4 rounded-sm" id="services">
      <div className="flex flex-col md:flex-row items-start justify-between max-w-6xl mx-auto space-y-8 md:space-y-0 md:space-x-8">
        <div className="w-full md:w-1/2 flex flex-col">
          ...
          <div className="space-y-4 flex flex-col flex-grow">
            ...
            <button className="bg-black text-white font-semibold py-2 px-6 rounded-full hover:bg-[#C06014] hover:text-white transition-colors duration-300 self-start">
              ORDER
            </button>
          </div>
        </div>
        <div className="w-full md:w-1/2 flex flex-col">
          ...
          <div className="space-y-4 flex flex-col flex-grow">
            ...
            <p className="tex-black flex-grow">
